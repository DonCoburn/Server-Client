...
struct client {
    ...
    int block_read; // block read in from socket
    int inverse; // inverse read in from socket
    unsigned char high_byte; // crc high byte read in from socket
    unsigned char low_byte; // crc low byte read in from socket
};
